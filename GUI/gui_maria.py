...
# Agriculture
agri_eda_images = {
    "Data": r"..\reports\figures\Dataset_1\df_1.png",
    "Columns": r"..\reports\figures\Dataset_1\info.png",
    "Quantiles": r"..\reports\figures\Dataset_1\descCol_1.png",
    "Histogram": r"..\reports\figures\Dataset_1\histo.png",
    "Box Plot": r"..\reports\figures\Dataset_1\box.png",
    "Scatter Plot": r"..\reports\figures\Dataset_1\scatter.png",
    "Fertility": r"..\reports\figures\Dataset_1\fertilityHist.png",
}

agri_process_images = {
    "Outliers": r"..\reports\figures\Dataset_1\outliers.png",
    "Box Plot": r"..\reports\figures\Dataset_1\no_outliers_box.png",
    "Hitmap": r"..\reports\figures\Dataset_1\features_hitmap.png",
    "Min-Max Normalization": r"..\reports\figures\Dataset_1\minMax_dist.png",
    "Z-score Normalization": r"..\reports\figures\Dataset_1\zscore_dist.png",
}

# Covid-19
covid_eda_images = {
    "Data": r"..\reports\figures\02_TSA_2\df_2.png",
    "Columns": r"..\reports\figures\02_TSA_2\info_2.png",
    "Quantiles": r"..\reports\figures\02_TSA_2\descCol_2.png",
    "Histogram": r"..\reports\figures\02_TSA_2\data2_Hist.png",
    "Bar Plot": r"..\reports\figures\02_TSA_2\data2_Bar.png",
}

dist_img = r"..\reports\figures\02_TSA_2\01_distribution_of_the_total_number_of_confirmed_cases_and_positive_tests_by_zones_bar_plot.png"
evol_img = r"..\reports\figures\02_TSA_2\02_evolution_over_time_for_94085.png"
dist2_img = r"..\reports\figures\02_TSA_2\03_distribution_of_positive_covid_cases_by_zone_and_year.png"
scatter_img = r"..\reports\figures\02_TSA_2\04_scatter_plot_of_population_and_test_count.png"
cases_img = r"..\reports\figures\02_TSA_2\05_total_number_of_cases_per_zone.png"
comp_img = r"..\reports\figures\02_TSA_2\06_comparison_of_confirmed_cases_tests_conducted_and_positive_tests_for_time_period.png"

# Fertility
fert_eda_images = {
    "Data": r"..\reports\figures\03_EDA\df_3.png",
    "Columns": r"..\reports\figures\03_EDA\info_3.png",
    "Quantiles": r"..\reports\figures\03_EDA\descCol_3.png",
    "Numerical": r"..\reports\figures\03_EDA\Data Distribution of Numeric Columns.png",
    "Categorical": r"..\reports\figures\03_EDA\Data_Distribution_of_Categorical_Columns.png",
}

freq_img = r"..\reports\figures\03_EDA\Discretized_Distribution_Frequency.png"
width_img = r"..\reports\figures\03_EDA\Discretized_Distribution_Width.png"
...
df = pd.read_csv(r"D:/2M/D.Mining\Data-Mining-Project/data/interim/03_static_dataset_features_built.csv")
